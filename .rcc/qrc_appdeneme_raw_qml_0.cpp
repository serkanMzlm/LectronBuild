...
0x0,0x0,0x1,0x92,0x8f,0xf9,0xec,0xc,
...
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appdeneme_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qInitResources_appdeneme_raw_qml_0)()
{
    int version = 3;
...
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appdeneme_raw_qml_0)();
int QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appdeneme_raw_qml_0)()
{
    int version = 3;
...
namespace {
   struct initializer {
       initializer() { QT_RCC_MANGLE_NAMESPACE(qInitResources_appdeneme_raw_qml_0)(); }
       ~initializer() { QT_RCC_MANGLE_NAMESPACE(qCleanupResources_appdeneme_raw_qml_0)(); }
   } dummy;
}
